  ...
  async generateHeader(doc, tipo, data) {
    ...
    switch (tipo) {
      ...
      case 'VC':
        ...
        doc.text('Destinatario', 265, 140);
        doc.text('Dest.', 350, 140);
        doc.text('Pzas', 370, 140);
        doc.text(data.neta ? 'Neta' : 'Kgs', 400, 140);
        doc.text('CONTADO', 455, 128);
        doc.text('Origen', 422, 140);
        doc.text('Imp.', 455, 140);
        doc.text('Destino', 480, 140);
    ...
    switch (tipo) {
      ...
      case 'VC':
        ...
        for (var item = 0; item < data.ventas.length; item++) {
          ...
          doc.y = ymin + i;
          doc.x = 123;
          doc.text(utils.truncate(data.ventas[item].dimensiones, 25), {
            align: 'left',
            columns: 1,
            width: 120,
          });
          doc.y = ymin + i;
          doc.x = 218;
          doc.text(utils.truncate(data.ventas[item].cliente_dest_desc, 35), {
            align: 'left',
            columns: 1,
            width: 150,
          });
      ...
      case 'RD':
          ...
          if (tipo == 'VCM' || tipo == 'VCD' || tipo == 'TVD') {
            ...
            doc.text(
              tipo == 'TV' || tipo == 'RD'
                ...
                : data.ventas[item].cliente.substr(0, 32),
              {
                align: 'left',
                columns: 1,
                width: 160,
                lineGap: -1.5, // Puedes probar con valores negativos, por ejemplo -2
              }
            );
            doc.y = ymin + i;
            doc.x = 140;
        ...
        doc.y = ymin + i;
        doc.x = tipo == 'VCM' || tipo == 'VCD' ? 115 : 140;
        ...
        doc.y = ymin + i;
        doc.x = tipo == 'VCM' || tipo == 'VCD' ? 165 : 170;
        doc.text(totalNroPiezas, {
          align: 'right',
          columns: 1,
          width: 60,
