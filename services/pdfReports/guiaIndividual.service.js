...
class GuiaIndividualService {
  ...
  async generateCustomerInformation(doc, detalleGuia) {
    for (var item = 0; item < detalleGuia.length; item++) {
      let y = 17;
      for (var x = 0; x < 3; x++) {
        ...
        doc.fontSize(16);
        doc.text(detalleGuia[item].nro_documento, 240, y + 11);
        ...
        doc.y = y + 13;
        doc.x = 333;
        doc.text(moment(detalleGuia[item].fecha_emision).format('DD/MM/YYYY'), {
          align: 'center',
          columns: 1,
          width: 80,
        });
        ...
        doc.y = y + 13;
        doc.x = 418;
        doc.text(utils.formatNumber(detalleGuia[item].peso_kgs), {
          align: 'center',
          columns: 1,
          width: 40,
        });
        ...
        doc.y = y + 13;
        doc.x = 463;
        doc.text(detalleGuia[item].nro_piezas, {
          align: 'center',
          columns: 1,
          width: 40,
        });
        ...
        doc.y = y + 13;
        doc.x = 508;
        doc.text(detalleGuia[item].siglas_org + '/' + detalleGuia[item].siglas_dest, {
          align: 'center',
          columns: 1,
          width: 80,
        });
        ...
        doc.y = y + 45;
        doc.x = 28;
        doc.text(detalleGuia[item]['clientes_org.razon_social'], {
          align: 'right',
          columns: 1,
          width: 270,
        });
        doc.y = y + 60;
        doc.x = 28;
        doc.text(detalleGuia[item]['clientes_org.rif_cedula'], {
          align: 'left',
          columns: 1,
          width: 270,
        });
        ...
        doc.x = 28;
        doc.text(
          detalleGuia[item]['clientes_org.dir_correo'] == '0'
            ? ''
            : detalleGuia[item]['clientes_org.dir_correo'],
          {
            align: 'right',
            columns: 1,
            width: 270,
        ...
        doc.y = y + 72;
        doc.x = 28;
        doc.text(detalleGuia[item]['clientes_org.tlf_cliente'], {
          align: 'left',
          columns: 1,
          width: 270,
        });
        doc.y = y + 84;
        doc.x = 28;
        doc.text(detalleGuia[item]['clientes_org.dir_fiscal'], {
          align: 'left',
          columns: 1,
          width: 270,
        });
        doc.y = y + 108;
        doc.x = 40;
        doc.text(detalleGuia[item]['clientes_org.parroquias.desc_parroquia'], {
          align: 'left',
          columns: 1,
          width: 100,
        });
        doc.y = y + 108;
        doc.x = 150;
        doc.text(detalleGuia[item]['clientes_org.municipios.desc_municipio'], {
          align: 'left',
          columns: 1,
          width: 100,
        });
        doc.y = y + 120;
        doc.x = 40;
        doc.text(detalleGuia[item]['clientes_org.ciudades.desc_ciudad'], {
          align: 'left',
          columns: 1,
          width: 100,
        });
        doc.y = y + 120;
        doc.x = 150;
        doc.text(detalleGuia[item]['clientes_org.ciudades.estados.desc_estado'], {
          align: 'left',
          columns: 1,
          width: 100,
        });
        doc.y = y + 132;
        doc.x = 40;
        doc.text(detalleGuia[item]['clientes_org.localidades.cod_postal'], {
          align: 'left',
          columns: 1,
          width: 100,
        });
        ...
        doc.x = 150;
        doc.text(
          detalleGuia[item]['clientes_org.ciudades.estados.paises.desc_pais'],
          {
            align: 'left',
            columns: 1,
            width: 100,
        ...
        doc.y = y + 150;
        doc.x = 23;
        doc.text(detalleGuia[item]['clientes_org.agencias.ciudades.desc_ciudad'], {
          align: 'center',
          columns: 1,
          width: 280,
        });
        ...
        doc.y = y + 45;
        doc.x = 313;
        doc.text(detalleGuia[item]['cliente_particular.nb_cliente'], {
          align: 'right',
          columns: 1,
          width: 270,
        });
        doc.y = y + 60;
        doc.x = 313;
        doc.text(detalleGuia[item]['cliente_particular.rif_ci'], {
          align: 'left',
          columns: 1,
          width: 270,
        });
        doc.y = y + 72;
        doc.x = 313;
        doc.text(detalleGuia[item]['cliente_particular.telefonos'], {
          align: 'left',
          columns: 1,
          width: 270,
        });
        doc.y = y + 84;
        doc.x = 313;
        doc.text(detalleGuia[item]['cliente_particular.direccion'], {
          align: 'left',
          columns: 1,
          width: 270,
        });
        ...
        doc.x = 330;
        doc.text(
          detalleGuia[item]['cliente_particular.parroquias.desc_parroquia'],
          {
            align: 'left',
            columns: 1,
            width: 100,
        ...
        doc.x = 440;
        doc.text(
          detalleGuia[item]['cliente_particular.municipios.desc_municipio'],
          {
            align: 'left',
            columns: 1,
            width: 130,
        ...
        doc.y = y + 120;
        doc.x = 330;
        doc.text(detalleGuia[item]['cliente_particular.ciudades.desc_ciudad'], {
          align: 'left',
          columns: 1,
          width: 100,
        });
        ...
        doc.x = 440;
        doc.text(
          detalleGuia[item]['cliente_particular.ciudades.estados.desc_estado'],
          {
            align: 'left',
            columns: 1,
            width: 100,
        ...
        doc.y = y + 132;
        doc.x = 330;
        doc.text(detalleGuia[item]['cliente_particular.localidades.cod_postal'], {
          align: 'left',
          columns: 1,
          width: 100,
        });
        ...
        doc.y = y + 150;
        doc.x = 308;
        doc.text(detalleGuia[item].zona_desc, {
          align: 'center',
          columns: 1,
          width: 280,
        });
        ...
        let modalidad = '';
        if (
          detalleGuia[item].modalidad_pago == 'CO' &&
          detalleGuia[item].pagado_en == 'O'
        ) {
          modalidad = 'CONTADO ORIGEN';
        } else if (
          detalleGuia[item].modalidad_pago == 'CO' &&
          detalleGuia[item].pagado_en == 'D'
        ) {
          modalidad = 'CONTADO DESTINO';
        } else if (
          detalleGuia[item].modalidad_pago == 'CR' &&
          detalleGuia[item].pagado_en == 'O'
        ) {
        ...
        let tipo_carga;
        if (detalleGuia[item].tipo_carga == 'SB') {
          tipo_carga = 'SOBRE';
        } else {
          tipo_carga = 'PAQUETE';
        }
        ...
        doc.y = y + 222;
        doc.x = 28;
        doc.text(detalleGuia[item].dimensiones, {
          align: 'left',
          columns: 1,
          width: 217,
        });
